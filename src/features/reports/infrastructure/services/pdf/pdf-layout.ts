...
export function addModernHeader(doc: typeof PDFDocument, reportTitle: string) {
  doc.rect(0, 0, DIMENSIONS.PAGE_WIDTH, DIMENSIONS.HEADER_HEIGHT)
  ...
  doc.rect(0, DIMENSIONS.HEADER_HEIGHT - 5, DIMENSIONS.PAGE_WIDTH, 5)
...
export function addModernFooter(
  ...
  doc.rect(0, footerY, DIMENSIONS.PAGE_WIDTH, 2)
  ...
  doc.fontSize(8)
     .text(
       ...
       DIMENSIONS.PAGE_WIDTH - DIMENSIONS.MARGIN - 100,
       footerY + 15,
...
export function addNewPage(doc: typeof PDFDocument) {
  doc.addPage();
  doc.y = DIMENSIONS.HEADER_HEIGHT + 20;
}
